...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """响应被外星人撞到的飞船"""
    """
    以碰撞作为参考进行循环，3条命只能完成2次碰撞，第3次直接结束。
    此处代码逻辑以3条命=3次碰撞事件出发是不严谨的。
    换言之，正确的行为是3条命只能调用2次此函数（即触发2次碰撞事件），第3次发生触发碰撞事件应直接结束游戏。
    """
